  ...
  <div class="limiter">
    ...
    <div style="border: 3px dashed #397C49; width:20%; margin-left:auto;margin-right:auto;text-align:center;padding-bottom:7px;padding-top:7px;">
      ...
      <form style="margin-left:auto; margin-right:auto; text-align:center;" action="#" method="post">
        <select name="Term">
          <option value='1'>Term 2 2017</option>
          <option value='2'>Term 3 2017</option>
          <option value='3'>Term 1 2018</option>
          <option value='5'>Term 2 2018</option>
          <option value='4'>Term 3 2018</option>
        </select>
    ...
    $class_name = "";
    if($term == 3){$term_name = "Term 1 2018";}elseif($term == 5){$term_name = "Term 2 2018";}elseif($term == 4){$term_name = "Term 3 2018";}elseif($term == 1){$term_name = "Term 2 2017";}elseif($term == 2){$term_name = "Term 3 2017";}
    ?>
