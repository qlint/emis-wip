...
<body>
  ...
  <div class="limiter">
    ...
    <div style="border: 3px dashed #397C49; width:20%; margin-left:auto;margin-right:auto;text-align:center;padding-bottom:7px;padding-top:7px;">
      ...
      <form style="margin-left:auto; margin-right:auto; text-align:center;" action="#" method="post">
        <select name="Term">
          ...
          <!--<option value='5'>Term 1 2019</option>
    ...
    $class_name = "";
    if($term == 2){$term_name = "Term 3 2018";}elseif($term == 3){$term_name = "Term 1 2019";}elseif($term == 4){$term_name = "Term 2 2019";}elseif($term == 5){$term_name = "Term 3 2019";}
    ?>
