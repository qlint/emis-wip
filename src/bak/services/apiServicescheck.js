angular.module('eduwebApp').service('apiService', [ '$rootScope', 'ajaxService', function($rootScope, ajaxService) {
	...
	var path = ( domain.indexOf('devhigh.eduweb.co.ke') > -1 ? 'http://devhighapi.eduweb.co.ke' : (domain.indexOf('eduweb.co.ke') > -1	? 'http://apihigh.eduweb.co.ke': 'http://apihigh.eduweb.localhost'));
