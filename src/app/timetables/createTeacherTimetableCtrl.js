...
controller('createTeacherTimetableCtrl', ['$scope', '$rootScope', 'apiService','$timeout','$window','$q','$parse',
function($scope, $rootScope, apiService, $timeout, $window, $q, $parse){
	...
	$scope.saveTimetable = function(){
		console.log("Timetable array to save",$scope.saveTeacherTimetable);
		// save to db
		var createCompleted = function ( response, status, params ){
			...
			if( result.response == 'success' ){
				...
				alert("Timetable has been successfully saved. To view and/or download it, click on the 'Teacher Timetable' tab.");
			}
			else{
				$scope.error = true;
		...
		var data = {
			time_tables: $scope.saveTeacherTimetable
		}
