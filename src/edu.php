<?php
/**
 * Clint | Single-File File Manager for Eduweb
 */
...
$auth_users = array(
    'clint' => '981bd6d0c1c27adda934ee70800bb1d1', //dev@mis
    'nancy' => 'fca078df1a45a4a7e073d5fbeb281268', //eduweb@rivercross
);
...
if ($use_auth) {
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="path login-form">
                <img src="assets/eduweb-edu.png" alt="Eduweb" style="margin:20px;">
...
<a href="http://eduweb.co.ke/" target="_blank" class="float-right" style="color:silver">&reg; &copy; Eduweb <script type="text/javascript">document.write((new Date()).getFullYear())</script></a></p>
<?php endif; ?>
</form>
...
<head>
<meta charset="utf-8">
<title>Eduweb | File Manager</title>
