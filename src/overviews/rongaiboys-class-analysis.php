  ...
  <div class="limiter">
    ...
    <div style="border: 3px dashed #397C49; width:20%; margin-left:auto;margin-right:auto;text-align:center;padding-bottom:7px;padding-top:7px;">
      ...
      <form style="margin-left:auto; margin-right:auto; text-align:center;" action="#" method="post">
        ...
        <select name="Classes">
          <option value='1'>Form 1 Gabriel</option>
          <option value='11'>Form 1 Michael</option>
          <option value='3'>Form 2 Gabriel</option>
          <option value='4'>Form 2 Michael</option>
          <option value='5'>Form 3 Gabriel</option>
          <option value='6'>Form 3 Michael</option>
          <option value='7'>Form 4 Gabriel</option>
          <option value='8'>Form 4 Michael</option>
        </select>
    ...
    $class_name = "";
    if($class == 1){$class_name = "Form 1 Gabriel";}elseif($class == 11){$class_name = "Form 1 Michael";}
    elseif($class == 3){$class_name = "Form 2 Gabriel";}elseif($class == 4){$class_name = "Form 2 Michael";}
    elseif($class == 5){$class_name = "Form 3 Gabriel";}elseif($class == 6){$class_name = "Form 3 Michael";}
    elseif($class == 7){$class_name = "Form 4 Gabriel";}elseif($class == 8){$class_name = "Form 4 Michael";}
    ?>
...
$table1 = pg_query($db,"SELECT t1.*, t3.marks, t2.rank as position FROM
                          ...
                          FROM   crosstab('SELECT student_name, subject_name, marks FROM (
                          			SELECT student_name, subject_name, round(avg(mark)) as marks, round(avg(grade_weight)) as grade_weight FROM(
                          				SELECT student_name, class_id, subject_name, parent_subject_name, exam_type_id, exam_type, student_id, sort_order, mark, grade_weight FROM (
