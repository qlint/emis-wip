    ...
    function vanillaSelectBox(domSelector, options) {
        ...
        vanillaSelectBox.prototype.init = function () {
            ...
            if (this.search) {
                ...
                // let fontSizeForP = this.isMultiple ? "8px" : "6px"; // edited by Clint
                let fontSizeForP = this.isMultiple ? "17px" : "6px";
            ...
            if(self.userOptions.stayOpen){
                ...
                this.main.addEventListener("click", function (e) {
                    ...
                    // self.drop.style.left = self.left + "px"; // edited out by Clint
                    // self.drop.style.top = self.top + "px"; // edited out by Clint
                    self.drop.style.display = "block";
